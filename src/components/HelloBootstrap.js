...
const HelloBootstrap = () => (
    ...
    <div className="jumbotron">
        <div className="container">
            ...
            <p><a className="btn btn-primary btn-lg" href="javascript:void(0)" role="button">Learn more &raquo;</a></p>
        </div>
    </div>
    ...
    <div className="container">
        <div className="row">
            <div className="col-md-4">
                ...
                <p><a className="btn btn-secondary" href="javascript:void(0)" role="button">View details &raquo;</a></p>
            </div>
            <div className="col-md-4">
                <h2>Heading</h2>
                <p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris
